        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Home', 'About the Clinic', 'Our Services', 'Patient Reviews', 'Book an Appointment'].map((item) => (
                <li key={item}>
                  <a href={`#${item.toLowerCase().replace(/ /g, '-')}`} className="text-white/60 hover:text-soft-teal transition-colors duration-200 text-sm flex items-center gap-2 group">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <p className="text-white/70 text-sm">+234 (0) 800 000 0000</p>
              </div>
              <div className="flex gap-4">
                <div className="text-soft-teal shrink-0">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-black/20 border-t border-white/5 py-8">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-8">
            ...
            <a href="#" className="flex items-center gap-3 px-6 py-3 bg-[#25D366] text-white rounded-xl font-bold text-sm shadow-lg shadow-emerald-500/20 hover:scale-105 active:scale-95 transition-all">
